...
func main() {
  ...
  for hl, line := range lines {
    ...
    if hl > 0 {
      fmt.Println(line[0] + " " + line[1])
      statement, err := env.db.Prepare("INSERT INTO stg_uni_melb_library (header_identifier , date_latest , metadata_identifier , metadata_identifier_handle_id , metadata_identifier_cms_id , metadata_identifier_accession_id , metadata_identifier_file_id , url ) VALUES ($1, $2, $3, $4, $5, $6, $7, $8)")
      if err != nil {
        fmt.Println(err)
        return
      }
